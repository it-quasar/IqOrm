...
#ifndef IQORMBASEINVERSEDMANYTOMANYPROPERTYDESCRIPTION_H
#define IQORMBASEINVERSEDMANYTOMANYPROPERTYDESCRIPTION_H

#include "iqorminversedmappedpropertydescription.h"
#include "iqormmanyobjectdescribingpropertydescription.h"
#include "iqorm_global.h"

class IQORMSHARED_EXPORT IqOrmBaseInversedManyToManyPropertyDescription :
        public IqOrmInversedMappedPropertyDescription,
        public IqOrmManyObjectDescribingPropertyDescription
{
    Q_OBJECT
public:
    explicit IqOrmBaseInversedManyToManyPropertyDescription(IqOrmMetaModel *parent = Q_NULLPTR);
...
#endif // IQORMBASEINVERSEDMANYTOMANYPROPERTYDESCRIPTION_H
