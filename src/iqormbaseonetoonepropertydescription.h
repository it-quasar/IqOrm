...
#ifndef IQORMBASEONETOONEPROPERTYDESCRIPTION_H
#define IQORMBASEONETOONEPROPERTYDESCRIPTION_H

#include "iqormoneobjectdescribingpropertydescription.h"
#include "iqormjoincolumndirectmappedpropertydescription.h"
#include "iqorm_global.h"

class IQORMSHARED_EXPORT IqOrmBaseOneToOnePropertyDescription :
        public IqOrmJoinColumnDirectMappedPropertyDescription,
        public IqOrmOneObjectDescribingPropertyDescription
{
    Q_OBJECT
public:
    explicit IqOrmBaseOneToOnePropertyDescription(IqOrmMetaModel *parent = Q_NULLPTR);
...
#endif // IQORMBASEONETOONEPROPERTYDESCRIPTION_H
