...
#error 'iqormmanyobjecdescibingpropertydescription_impl.h' is not supposed to be included directly. Include 'iqormmanyobjectdescribingpropertydescription.h' instead.
#endif
