...
#ifndef IQORMSQLINVERSEDMANYTOMANYPROPERTYDESCRIPTIONPROCESSOR_H
#define IQORMSQLINVERSEDMANYTOMANYPROPERTYDESCRIPTIONPROCESSOR_H

#include "iqormsqlmanyobjectsdescribingpropertydescriptionprocessor.h"
#include "iqorm_global.h"

class IQORMSHARED_EXPORT IqOrmSqlInversedManyToManyPropertyDescriptionProcessor : public IqOrmSqlManyObjectsDescribingPropertyDescriptionProcessor
{
public:
    explicit IqOrmSqlInversedManyToManyPropertyDescriptionProcessor();

public:
    const IqOrmBaseInversedManyToManyPropertyDescription *propertyDescription() const;
...
private:
    const IqOrmBaseManyToManyPropertyDescription *associatedPropertyDescription() const;
    QString escapedAssociatedObjectTableName() const;
};

#endif // IQORMSQLINVERSEDMANYTOMANYPROPERTYDESCRIPTIONPROCESSOR_H
