...
#ifndef IQORMSQLONETOONEPROPERTYDESCRIPTIONPROCESSOR_H
#define IQORMSQLONETOONEPROPERTYDESCRIPTIONPROCESSOR_H

#include "iqormsqloneobjectdescrtibingpropertydescriptionprocessor.h"
#include "iqormbaseonetoonepropertydescription.h"
#include "iqorm_global.h"

class IQORMSHARED_EXPORT IqOrmSqlOneToOnePropertyDescriptionProcessor : public IqOrmSqlOneObjectDescrtibingPropertyDescriptionProcessor
{
public:
    explicit IqOrmSqlOneToOnePropertyDescriptionProcessor();

public:
    const IqOrmBaseOneToOnePropertyDescription *propertyDescription() const;
...
private:
    const IqOrmBaseInversedOneToOnePropertyDescription *associatedPropertyDescription() const;
    QString escapedJoinColumnName() const;
    qint64 oldPropertyObjectOwnerObjectId(IqOrmDataSourceOperationResult *result,
                            bool *ok) const;
};

#endif // IQORMSQLONETOONEPROPERTYDESCRIPTIONPROCESSOR_H
