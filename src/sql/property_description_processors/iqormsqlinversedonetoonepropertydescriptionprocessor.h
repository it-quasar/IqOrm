...
#ifndef IQORMSQLINVERSEDONETOONEPROPERTYDESCRIPTIONPROCESSOR_H
#define IQORMSQLINVERSEDONETOONEPROPERTYDESCRIPTIONPROCESSOR_H

#include "iqormsqloneobjectdescrtibingpropertydescriptionprocessor.h"
#include "iqorm_global.h"

class IQORMSHARED_EXPORT IqOrmSqlInversedOneToOnePropertyDescriptionProcessor : public IqOrmSqlOneObjectDescrtibingPropertyDescriptionProcessor
{
public:
    explicit IqOrmSqlInversedOneToOnePropertyDescriptionProcessor();

public:
    const IqOrmBaseInversedOneToOnePropertyDescription *propertyDescription() const;
...
private:
    const IqOrmBaseOneToOnePropertyDescription *associatedPropertyDescription() const;
    QString escapedAssociatedObjectTableName() const;
    QString escapedAssociatedJoinColumnName() const;
    qint64 oldObjectOwnerObjectId(IqOrmDataSourceOperationResult *result,
                                  bool *ok) const;
};

#endif // IQORMSQLINVERSEDONETOONEPROPERTYDESCRIPTIONPROCESSOR_H
